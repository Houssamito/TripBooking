...
@endauth
	...
	<!-- <header class="text-center" name="home">
		<div class="intro-text">
			<h1 class="wow fadeInDown">Welcome to <strong><span class="color">TripBooking</span></strong></h1>
			<p class="wow fadeInDown">Découvrez le monde avec notre agence de services touristiques</p>
			<a href="#" class="btn btn-default btn-lg page-scroll wow fadeInUp" data-wow-delay="200ms"> <div class="search-container">
					...
					<div class="box-container">
						...
						<div class="box" data-category="{{ $Activity->Categorie }}"  >
							...
							<div class="Favoris" data-id="{{ $Activity->id }}">
								<form action="{{ route('Profile.addToFavoris', ['id' => $Activity->id]) }}" method="POST" style="display: inline;">
									@csrf
